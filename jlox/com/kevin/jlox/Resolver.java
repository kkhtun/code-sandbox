...
class Resolver implements Expr.Visitor<Void>, Stmt.Visitor<Void> {
    ...
    // SUBCLASS - a class that has a superclass
    ...
    private void declare(Token name) {
        ...
        // We won't be allowing duplicate variable declaration in local (unlike global)
    ...
    public Void visitReturnStmt(Stmt.Return stmt) {
        ...
        if (stmt.value != null) {
            // Cannot return a value from initializer
    ...
    public Void visitGetExpr(Expr.Get expr) {
        // We'll only resolve the object instance itself e.g. instance.property
        resolve(expr.object);
        return null;
    }
    ...
    public Void visitSetExpr(Expr.Set expr) {
        resolve(expr.object); // Similar to Expr.Get
        resolve(expr.value); // The value it’s being set to
        return null;
    }
